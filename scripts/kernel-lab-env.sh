...
readonly KERNEL_VERSION="${KERNEL_VERSION:-7.3-rc2}"
...
readonly DOWNLOAD_DIR="${DOWNLOAD_DIR:-/home/manuel/Downloads/kernel}"
...
readonly TARBALL="${TARBALL:-${DOWNLOAD_DIR}/linux-${KERNEL_VERSION}.tar.gz}"
